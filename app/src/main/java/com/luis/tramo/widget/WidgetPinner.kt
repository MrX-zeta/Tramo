...
/**
 * Requests the launcher to pin the Tramo focus-ring widget to the home screen. Called right after
...
class WidgetPinner @Inject constructor(
    ...
    fun requestPin() {
        ...
        val provider = ComponentName(context, TramoWidgetReceiver::class.java)
