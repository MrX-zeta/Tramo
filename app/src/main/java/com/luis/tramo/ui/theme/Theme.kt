...
private val LightColors = lightColorScheme(
    ...
    onSurface = TramoInk,
    // Tonal elevation ladder (light): cards sit above the background.
    surfaceContainerLowest = Color(0xFFFFFFFF),
    surfaceContainerLow = Color(0xFFFCFBF7),
...
private val DarkColors = darkColorScheme(
    ...
    // Warm green-charcoal tonal ladder (dark): background darkest, each container a step lighter.
    background = Color(0xFF0E1513),
    onBackground = Color(0xFFE1E6E5),
    surface = Color(0xFF131B19),
    onSurface = Color(0xFFE1E6E5),
    surfaceDim = Color(0xFF0E1513),
    surfaceBright = Color(0xFF2C3835),
    surfaceContainerLowest = Color(0xFF0A100E),
    surfaceContainerLow = Color(0xFF182220),
    surfaceContainer = Color(0xFF1D2725),
    surfaceContainerHigh = Color(0xFF24302D),
    surfaceContainerHighest = Color(0xFF2C3835),
    surfaceVariant = Color(0xFF3A4642),
